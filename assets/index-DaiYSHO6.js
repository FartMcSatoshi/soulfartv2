import{t as h,E as b,O as v,z as w,v as g,x as r}from"./web3-libs-CWH8scYH.js";import{n as o,o as p}from"./if-defined-CemL2qSm.js";import"./index-CASfriZ_.js";import"./index-smxtHXFl.js";import"./index-D7TiUfiD.js";const x=h`
  button {
...
`;var t=function(u,a,e,s){var l=arguments.length,n=l<3?a:s===null?s=Object.getOwnPropertyDescriptor(a,e):s,d;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(u,a,e,s);else for(var c=u.length-1;c>=0;c--)(d=u[c])&&(n=(l<3?d(n):l>3?d(a,e,n):d(a,e))||n);return l>3&&n&&Object.defineProperty(a,e,n),n};let i=class extends g{constructor(){super(...arguments),this.tabIdx=void 0,this.variant="icon",this.disabled=!1,this.imageSrc=void 0,this.alt=void 0,this.chevron=!1,this.loading=!1}render(){return r`
    ...
    `}visualTemplate(){if(this.variant==="image"&&this.imageSrc)return r`<wui-image src=${this.imageSrc} alt=${this.alt??"list item"}></wui-image>`;if(this.iconVariant==="square"&&this.icon&&this.variant==="icon")return r`<wui-icon name=${this.icon}></wui-icon>`;if(this.variant==="icon"&&this.icon&&this.iconVariant){const a=["blue","square-blue"].includes(this.iconVariant)?"accent-100":"fg-200",e=this.iconVariant==="square-blue"?"mdl":"md",s=this.iconSize?this.iconSize:e;return r`
      ...
      `}return null}loadingTemplate(){return this.loading?r`<wui-loading-spinner
        ...
        color="fg-300"
      ></wui-loading-spinner>`:r``}chevronTemplate(){return this.chevron?r`<wui-icon size="inherit" color="fg-200" name="chevronRight"></wui-icon>`:null}};i.styles=[b,v,x];t([o()],i.prototype,"icon",void 0);t([o()],i.prototype,"iconSize",void 0);t([o()],i.prototype,"tabIdx",void 0);t([o()],i.prototype,"variant",void 0);t([o()],i.prototype,"iconVariant",void 0);t([o({type:Boolean})],i.prototype,"disabled",void 0);t([o()],i.prototype,"imageSrc",void 0);t([o()],i.prototype,"alt",void 0);t([o({type:Boolean})],i.prototype,"chevron",void 0);t([o({type:Boolean})],i.prototype,"loading",void 0);i=t([w("wui-list-item")],i);
